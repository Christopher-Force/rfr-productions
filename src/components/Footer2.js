...
const Footer2 = () => {
    return (
        <footer className="bg-white dark:bg-gray-800 pt-4">
            <div className="container px-6 py-4 mx-auto">
                <div className="lg:flex">
                    <div className="w-full -mx-6 lg:w-2/5">
                        <div className="px-6">
                            <div className="flex items-center md:justify-items-center sm:justify-center grid grid-cols-3 md:grid-cols-3 xl:grid-cols-7 pb-2 md:pb-0">
                                <img src={rfrblack} width="50" className="xl:cols-span-3 col-span-1 lg:justify-self-center xl:justify-self-start md:justify-self-end justify-self-center xl:col-start-2" />
                                <a href="#" className="xl:pl-3 col-span-2 xl:col-span-4 md:col-span-2 md:justify-self-start md:pl-4 text-xl font-bold text-gray-800 dark:text-white hover:text-gray-700 dark:hover:text-gray-300">Sounds that sound good with anyone.</a>
                            </div>
                            
                            {/* <p className="max-w-md mt-2 text-gray-500 dark:text-gray-400">Sounds that sound good with anyone.</p> */}
                    ...
                    <div className="mt-6 lg:mt-0 lg:flex-1">
                        <div className="grid grid-cols-3 gap-6 sm:grid-cols-3 md:grid-cols-3 justify-items-center">
                            ...
                            <div>
                                ...
                                <span className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">ChrisForceProduction@gmail.com</span> */}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <p className="text-center text-gray-800 dark:text-white">© RFR Productions 2021 - All rights reserved</p>
                </div>
            </div>
        </footer>
    )
