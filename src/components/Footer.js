            ...
            <div className="bg-gray-100">
                <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
                    ...
                    <div className='logo-container'>
                        <img src={rfrblack} height={50} width={50} alt='RFR logo' />
                    </div>
                    <span className="ml-3 text-xl">RFR Productions</span>
                    </a>
                    <p className="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">© 2021 RFR Productions —
                        <a href="https://twitter.com/runforcerun" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">@runforcerun</a>
                    </p>
